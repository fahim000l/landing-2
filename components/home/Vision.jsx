...
const Vision = () => {
    ...
    return (
        <div id="vision" className="flex lg:flex-row flex-col-reverse lg:bg-[white] bg-[#F4F4F4] lg:w-[70rem] mx-auto lg:pl-10 rounded-[10px] lg:mt-20 mt-20 w-[95%] shadow-lg md:mt-0">
