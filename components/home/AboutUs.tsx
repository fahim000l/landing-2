...
const AboutUs = () => {
    ...
    return (
        <section id='about_us' className='flex lg:flex-row flex-col-reverse justify-center lg:items-center lg:bg-[white] bg-[#F4F4F4] lg:w-[70rem] w-[95%] mx-auto  p-5 lg:p-10 md:p-10 lg:rounded-[10px] rounded-[5px] lg:mt-10 shadow-lg'>
            <div className='ml-[150px] -mt-[150px] lg:-mt-0 lg:-ml-0 lg:w-[50%] h-[307px] z-[500] flex flex-col items-end lg:items-start'>
            ...
            <Image alt='about_us' src={aboutUsImage} className='lg:-ml-[100px] lg:w-[50%] w-[70%] md:w-[50%] lg:h-[60vh] h-[40vh] lg:rounded-[10px] rounded-[5px]' />
        </section>
    )
}
